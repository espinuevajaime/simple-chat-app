            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="login__form">
                    ...
                    <div class="login__row">
                        ...
                        <input type="text"  name="email" class="login__input name"  placeholder="Username" value="test@mail.com"/>
                        @error('email')
                    ...
                    <div class="login__row">
                        ...
                        <input type="password" name="password" class="login__input pass" placeholder="Password" value="password1234"/>
                        @error('password')
                        <span class="invalid-feedback login__signup" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
